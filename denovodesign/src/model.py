...
RWKV_HEAD_QK_DIM = 0 # what does it actually stand for?
...
class GPT(nn.Module):
    def __init__(self, config):
        ...
        self.atan = atan() # atan function is applied to create a binary embedding out of the normal embedding
