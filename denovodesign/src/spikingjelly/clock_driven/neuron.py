...
try:
    import cupy
    print("CUPY IMPORTED")
    from . import neuron_kernel
    print("ATTTTEEEENTION: imported neuron kernel successfully")
    from . import cu_kernel_opt
    print("ATTTTEEEENTION: imported cu kernel successfully")
...
def check_backend(backend: str):
    if backend == 'torch':
        ...
        #print("TODO: add back assertion for cupy")
